...
def fff(queryImgPath):
    ...
    #queryImgPath = "./data/fashionTexture/striped/17.jpg"  #pointer to an image anywhere on disk
    ...
    plt.draw()
    plt.savefig(queryImgPath, dpi=200, bbox_inches='tight')
    #plt.show()
